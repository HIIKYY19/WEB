...
$datajenistiket = $model->datajenistiket();
?>
...
<main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card-header">
                                ...
                                <a href="index.php?url=jenistiket_form">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php
                                        foreach($datajenistiket as $row){
                                        
                                        ?>
                                        <tr>
                                        <td> <?=$row['id'] ?> </td>
                                        <td> <?=$row['nama'] ?> </td>
                                        <td> <?=$row['max_kapasitas_bawaan'] ?> </td>
                                            
                                        <td>
                                        <form action="jenistiket_controller.php" method="POST">
                                                <a href="index.php?url=jenistiket_detail&id=<?= $row['id']?>">
                                                    <button type="button" class="btn btn-info">Detail</button>
                                                </a>
                                                <a href="index.php?url=jenistiket_form&idedit=<?= $row['id']?>">
